...
void Receiver::update()
{
    ...
    // Ch6 is Home Set Toggle: Toggled logic
    bool currentCh6State = readChannel(5, 0, 100, 0) > 50;
    if (currentCh6State && !lastCh6State)
    {
        currentData.setHome = true;
    }
    else
    {
        currentData.setHome = false;
    }
    lastCh6State = currentCh6State;
}
